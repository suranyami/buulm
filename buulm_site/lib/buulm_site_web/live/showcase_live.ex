      ...
      <section>
        <div class="max-w-full mx-auto px-4 py-8">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <.showcase_entry image_url="/images/showcase/uini.png" url="https://uini.io?utm_source=buulm">
              <:name>Uini</:name>
              <:description>AI-powered user-research tool</:description>
            </.showcase_entry>
            <.showcase_entry image_url="/images/showcase/mealmind.png" url="https://mealmind.io?utm_source=buulm">
              <:name>mealmind</:name>
