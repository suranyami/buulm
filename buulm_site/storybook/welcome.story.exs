defmodule Storybook.MyPage do
  ...
  def doc, do: "How to get started with Buulm"
  ...
  def render(assigns = %{tab: :welcome}) do
    ...
    <div class="psb-welcome-page">
      <p>
        ...
        <strong>
          <a href="https://github.com/chrisgreg/buulm" target="_blank">
            See github
          </a>
        </strong>
      ...
      <div>
        <h2>Installation</h2>
        <p>Can be installed by adding buulm to your list of dependencies in mix.exs:</p>
        ...
        <pre><code>mix buulm.install &lt;component_name&gt;</code></pre>
        <p>
        ...
        <pre><code>mix buulm.install help</code></pre>
      </div>
    </div>
    """
  end
